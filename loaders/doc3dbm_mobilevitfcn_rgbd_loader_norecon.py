...
class doc3dbm_mobilevitfcn_rgbd_loader_norecon(data.Dataset):
    """
    Data loader.
    """
    ...
    def transform(self, alb,dmap, bm):
        ...
        rgbd=torch.cat([alb*ensuremsk,dmap],dim=0)
...
#with torch.autograd.profiler.profile(enabled=True) as prof:
    dst = doc3dbm_mobilevitfcn_rgbd_loader_norecon(root='/disk2/sinan/doc3d/', split='valmini', is_transform=True, img_size=(128,128))
