...
class doc3dbm_rgb_absoluted_norecon(data.Dataset):
    """
    Data loader.
    """
...
#with torch.autograd.profiler.profile(enabled=True) as prof:
    dst = doc3dbm_rgb_absoluted_norecon(root='/disk2/sinan/doc3d/', split='trainmini', is_transform=True, img_size=(128,128))
