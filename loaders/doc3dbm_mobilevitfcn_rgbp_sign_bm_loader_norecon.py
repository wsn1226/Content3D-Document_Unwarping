...
class doc3dbm_mobilevitfcn_rgbp_sign_bm_loader_norecon(data.Dataset):
    """
    Data loader.
    """
...
#with torch.autograd.profiler.profile(enabled=True) as prof:
    dst = doc3dbm_mobilevitfcn_rgbp_sign_bm_loader_norecon(root='/disk2/sinan/doc3d/', split='trainmini', is_transform=True, img_size=(128,128))
