...
#with torch.autograd.profiler.profile(enabled=True) as prof:
    dst = doc3dbm_nm(root='/disk2/sinan/doc3d/', split='trainmini', is_transform=True, img_size=(128,128))
    ...
    for i, data in enumerate(trainloader):
        ...
        for i in range(0,labels.shape[0]):
            cv2.imwrite('testnm'+str(i)+'.png',imgs[i,:,:,:].permute(1,2,0).numpy()*255)
