...
def train(args):
    ...
    # Setup Dataloader
    data_loader = get_loader('doc3dbm')
    ...
    experiment_name='bm_0' #network_activation(t=[-1,1])_dataset_lossparams_augmentations_trainstart
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logdir', nargs='?', type=str, default='./checkpoints-bm0/',    
...
#CUDA_VISIBLE_DEVICES=0 python trainbm0.py --arch mobilevit_sandfcn --data_path /disk2/sinan/doc3d/ --img_rows 128 --img_cols 128 --n_epoch 300 --batch_size 200 --l_rate 0.00005 --tboard --resume /home/sinan/DewarpNet-master/checkpoints-bm0/mobilevit_sandfcn_30_0.0007522332156077027_0.000342360789859324_bm_0_model.pkl