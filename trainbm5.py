...
def train(args):
    ...
    # Setup Dataloader
    data_loader = get_loader('doc3dbm_rgbd')
    ...
    experiment_name='bm_5' #network_activation(t=[-1,1])_dataset_lossparams_augmentations_trainstart
    ...
    for epoch in range(epoch_start,args.n_epoch):
        ...
        for i, (images, labels) in enumerate(trainloader):
            ...
            loss=l1loss  #+ (0.3*ssim) The L_T loss for the textured mapping network
            # loss=l1loss  
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logdir', nargs='?', type=str, default='./checkpoints-bm5/',    
...
# CUDA_VISIBLE_DEVICES=2 python trainbm5.py --arch mobilevit_sandfcnRGBD --data_path /disk2/sinan/doc3d/ --img_rows 128 --img_cols 128 --n_epoch 300 --batch_size 200 --l_rate 0.0001 --resume /home/sinan/DewarpNet-master/checkpoints-bm5/mobilevit_sandfcnRGBD_9_0.0004073188203619793_0.00042028217193864514_bm_5_best_model.pkl