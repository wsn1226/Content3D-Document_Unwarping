...
class MobileViT_FCN(nn.Module):
    def __init__(self, image_size, dims, channels, num_classes, expansion=4, kernel_size=3, patch_size=(2, 2),input_channels=3,mode=None):
        ...
        self.mvit.append(MobileViTBlock(64, 2, channels[1], kernel_size, patch_size, 128))
        self.mvit.append(MobileViTBlock(80, 2 , channels[2], kernel_size, patch_size, 160))
        self.mvit.append(MobileViTBlock(96, 2 , channels[3], kernel_size, patch_size, 192))
...
def mobilevit_s_skip_6vitblocks(img_size=(256,256),input_channels=3,mode=None,num_classes=2):
    dims = [144, 192, 240]
...
if __name__ == '__main__':
    ...
    vit = mobilevit_s_skip_6vitblocks(input_channels=4,num_classes=2)
    out = vit(img)
    print(out.shape)
