...
class MobileViT_FCN(nn.Module):
    def __init__(self, image_size, dims, channels, num_classes, expansion=4, kernel_size=3, patch_size=(2, 2),input_channels=3,mode=None):
        ...
        self.mvit.append(MobileViTBlock(96, 2, channels[2], kernel_size, patch_size, 192))
        self.mvit.append(MobileViTBlock(120, 2 , channels[3], kernel_size, patch_size, 240))
...
def mobilevit_s_skip_5vitblocks(img_size=(256,256),input_channels=3,mode=None,num_classes=2):
    dims = [144, 192, 240]
...
if __name__ == '__main__':
    ...
    vit = mobilevit_s_skip_5vitblocks(input_channels=4,num_classes=2)
    out = vit(img)
    print(out.shape)
