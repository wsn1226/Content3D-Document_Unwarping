...
def mobilevit_xxs(img_size=(256,256),input_channels=3):
    dims = [64, 80, 96]
    channels = [16, 16, 24, 24, 48, 48, 64, 64, 80, 80, 320]
    return MobileViT_FCN(img_size, dims, channels, num_classes=2, expansion=2,input_channels=input_channels)


def mobilevit_xs(img_size=(256,256),input_channels=3):
    dims = [96, 120, 144]
    channels = [16, 32, 48, 48, 64, 64, 80, 80, 96, 96, 384]
    return MobileViT_FCN(img_size, dims, channels, num_classes=2,input_channels=input_channels)


def mobilevit_s(img_size=(256,256),input_channels=3):
    dims = [144, 192, 240]
