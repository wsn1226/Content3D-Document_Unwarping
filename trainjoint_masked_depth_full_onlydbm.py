...
def train(args):
    ...
    model_joint=get_model(name='u2net_joint_mobilevit_onlydbm_rgbdiff',depth_model=model_depth,bm_model=model_bm)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume_boundary', nargs='?', type=str, default=None,    
                        help='Path to previous saved model to restart from')
    parser.add_argument('--logdir_depth', nargs='?', type=str, default='./checkpoints-jointmskdepth_rgbdiff-u2depth_full/',    
                        help='Path to store the loss logs')
    parser.add_argument('--logdir_bm', nargs='?', type=str, default='./checkpoints-jointmskdepth_rgbdiff-bm_full/',    
                        help='Path to store the loss logs')
...
#CUDA_VISIBLE_DEVICES=1,2,0 python trainjoint_masked_depth_full_onlydbm.py --data_path /disk2/sinan/doc3d/ --batch_size 40 --tboard --resume_boundary /home/sinan/DewarpNet-master/checkpoints-u2net-nopre/u2net_132_0.010844790506031037_0.04020660579093357_boundary_best_model.pkl --resume_depth /home/sinan/DewarpNet-master/checkpoints-jointmskdepth_rgbdiff-u2depth_full/u2net_depth_143_0.03696584585494698_joint_masked_depth_best_model.pkl --resume_bm /home/sinan/DewarpNet-master/checkpoints-jointmskdepth_rgbdiff-bm_full/mobilevit_sandfcn_skipRGBD_143_0.013566674167712846_joint_masked_depth_best_model.pkl