...
def train(args):
    ...
    # Setup Dataloader
    data_loader = get_loader('doc3dbm_flow')
    ...
    # LR Scheduler
    sched=torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='min', factor=0.5, patience=4, verbose=True)
    ...
    experiment_name='bm_8' #network_activation(t=[-1,1])_dataset_lossparams_augmentations_trainstart
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logdir', nargs='?', type=str, default='./checkpoints-bm8/',    
...
#CUDA_VISIBLE_DEVICES=2 python trainbm8.py --arch mobilevit_sandfcn_skip --data_path /disk2/sinan/doc3d/ --img_rows 128 --img_cols 128 --n_epoch 300 --batch_size 190 --l_rate 0.0001 --tboard