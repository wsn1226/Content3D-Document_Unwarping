...
def train(args):
    ...
    experiment_name='bm_3' #network_activation(t=[-1,1])_dataset_lossparams_augmentations_trainstart
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logdir', nargs='?', type=str, default='./checkpoints-bm3/',    
...
#CUDA_VISIBLE_DEVICES=0 python trainbm3.py --arch mobilevit_sandfcn --data_path /disk2/sinan/doc3d/ --img_rows 128 --img_cols 128 --n_epoch 300 --batch_size 200 --l_rate 0.0001 --resume /home/sinan/DewarpNet-master/checkpoints-bm3/mobilevit_sandfcn_4_0.0007916302781086415_0.0009281804139671318_bm_3_best_model.pkl