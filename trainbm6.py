...
def train(args):
    ...
    # Setup Dataloader
    data_loader = get_loader('doc3dbm_wc')
    ...
    # Setup Model
    model = get_model(args.arch, n_classes,in_channels=2, img_size=(args.img_rows, args.img_cols))
    ...
    experiment_name='wc' #network_activation(t=[-1,1])_dataset_lossparams_augmentations_trainstart
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', nargs='?', type=int, default=200, 
                        help='Batch Size')
    parser.add_argument('--l_rate', nargs='?', type=float, default=6.25e-06, 
                        help='Learning Rate')
...
#CUDA_VISIBLE_DEVICES=1,0,2 python trainbm6.py --arch mobilevit_sandfcn_skip --data_path /disk2/sinan/doc3d/ --img_rows 128 --img_cols 128 --resume /home/sinan/DewarpNet-master/checkpoints-wc/mobilevit_sandfcn_skip_61_5.047573707997799e-05_0.00010055505071863645_wc_best_model.pkl