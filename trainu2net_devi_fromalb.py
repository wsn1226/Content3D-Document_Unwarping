...
grid=torch.cat([grid_y.unsqueeze(-1),grid_x.unsqueeze(-1)],dim=-1).to(torch.float32).to(device)
...
def train(args):
    ...
    for epoch in range(epoch_start,args.n_epoch):
        ...
        for i, (images, labels) in enumerate(trainloader):
            ...
            only_d0=relu(d0[msk_index[:,0],:,msk_index[:,1],msk_index[:,2]])
            only_d1=relu(d1[msk_index[:,0],:,msk_index[:,1],msk_index[:,2]])
            only_d2=relu(d2[msk_index[:,0],:,msk_index[:,1],msk_index[:,2]])
            only_d3=relu(d3[msk_index[:,0],:,msk_index[:,1],msk_index[:,2]])
            only_d4=relu(d4[msk_index[:,0],:,msk_index[:,1],msk_index[:,2]])
            only_d5=relu(d5[msk_index[:,0],:,msk_index[:,1],msk_index[:,2]])
            only_d6=relu(d6[msk_index[:,0],:,msk_index[:,1],msk_index[:,2]])
