...
def train(args):
    ...
    experiment_name='bm_9' #network_activation(t=[-1,1])_dataset_lossparams_augmentations_trainstart
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logdir', nargs='?', type=str, default='./checkpoints-bm9/',    
...
#CUDA_VISIBLE_DEVICES=0,2 python trainbm9.py --arch mobilevit_sandfcn_skipRGBD --data_path /disk2/sinan/doc3d/ --img_rows 256 --img_cols 256 --n_epoch 300 --batch_size 200 --l_rate 0.0001