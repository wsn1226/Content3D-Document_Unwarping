...
def train(args):
    ...
    # Setup Dataloader
    data_loader = get_loader('doc3dbm_nm')
    ...
    experiment_name='bm_4' #network_activation(t=[-1,1])_dataset_lossparams_augmentations_trainstart
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logdir', nargs='?', type=str, default='./checkpoints-bm4/',    
...
#CUDA_VISIBLE_DEVICES=1 python trainbm4.py --arch mobilevit_sandfcn_skip --data_path /disk2/sinan/doc3d/ --img_rows 128 --img_cols 128 --n_epoch 300 --batch_size 200 --l_rate 0.0001 --resume /home/sinan/DewarpNet-master/checkpoints-bm4/mobilevit_sandfcn_skip_4_0.00041238400619477035_0.0005056818901362208_bm_3_best_model.pkl